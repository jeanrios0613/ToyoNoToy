...
namespace FormChenchen.Migrations
{
    ...
    [Migration("20250526181921_MigracionInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FormChenchen.Models.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("FormChenchen.Models.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FormChenchen.Models.DocumentReference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FormChenchen.Models.Enterprise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FormChenchen.Models.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FormChenchen.Models.RequestDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FormChenchen.Models.RequestDetailsCopium", b =>
                {
                    b.Property<DateTime>("CreationDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("FormChenchen.Models.RequestInfo", b =>
                {
            ...
            modelBuilder.Entity("FormChenchen.Models.RequestsCopium", b =>
                {
                    b.Property<string>("Code")
                        .IsRequired()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("FormChenchen.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("FormChenchen.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("Updatepass")
                        .HasColumnType("datetime2")
            ...
            modelBuilder.Entity("FormChenchen.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("FormChenchen.Models.VwUserRolesInfo", b =>
                {
                    b.Property<string>("Description")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("FormChenchen.Models.Contact", b =>
                {
                    b.HasOne("FormChenchen.Models.Request", "Request")
                        .WithOne("Contact")
                        .HasForeignKey("FormChenchen.Models.Contact", "RequestId")
            ...
            modelBuilder.Entity("FormChenchen.Models.Enterprise", b =>
                {
                    b.HasOne("FormChenchen.Models.Request", "Request")
                        .WithOne("Enterprise")
                        .HasForeignKey("FormChenchen.Models.Enterprise", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FormChenchen.Models.RequestDetail", b =>
                {
                    b.HasOne("FormChenchen.Models.Request", "Request")
                        ...
                        .HasForeignKey("FormChenchen.Models.RequestDetail", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
