...
namespace FormChenchen.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fecha_Actualizacion = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UPDATEPASS = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ruc = table.Column<string>(type: "varchar(28)", unicode: false, maxLength: 28, nullable: false),
                    ...
                    MonthlySales = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    ProyectedSales = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
