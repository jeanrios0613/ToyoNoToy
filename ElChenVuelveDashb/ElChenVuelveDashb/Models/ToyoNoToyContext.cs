...
public partial class ToyoNoToyContext : DbContext
{
    ...
    public virtual DbSet<AtencionFor> AtencionFors { get; set; }

    public virtual DbSet<Estadossol> Estadossols { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Archivo__3214EC0719038992");
        ...
        modelBuilder.Entity<AtencionFor>(entity =>
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Atencion__40F9A20726BA4C9C");

            entity.ToTable("AtencionFor");

            entity.Property(e => e.Codigo).HasColumnName("codigo");
            entity.Property(e => e.Empresa)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Montoaprueba)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("montoaprueba");
        });

        modelBuilder.Entity<Estadossol>(entity =>
        {
            entity.HasKey(e => e.Codigo).HasName("PK__ESTADOSS__40F9A207E5CCA004");

            entity.ToTable("ESTADOSSOL");
